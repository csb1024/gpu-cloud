...
NVPROF_LOG_PARSER='parseNvprof3.py'
...
./analyzeCaffe_kernel3.sh $GENERATOR_DIR/data_generator.prototxt $layer $NVPROF_LOG_DIR $CAFFE_LOG_DIR $GPU_ID $profile 
