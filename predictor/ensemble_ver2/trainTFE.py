...
def parse_args():
	...
	parser.add_argument('en_id',
			help='the id of ensemble network')
...
# Network Parameters
	...
	n_hidden = (int(args.en_id)+1) * data_vec_size  # allocated heuristically
...
#learning_rate = starter_learning_rate
	learning_rate = tf.train.exponential_decay(starter_learning_rate,global_step,max_training_epochs/50,0.9,staircase=True)
