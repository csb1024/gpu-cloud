...
def parse_args():
	...
	parser.add_argument('checkpoint_dir',
			help='directory where checkpoint files will be stored')
...
#	print("CAN YOU SEEME!")
	...
	data_size = len(trn_data)
	print ("number of training data: ",'%4d'%data_size)
...
# Hyper-Parameters
	...
	starter_learning_rate=float(args.init_lr) 
...
#learning_rate = starter_learning_rate
	learning_rate = tf.train.exponential_decay(starter_learning_rate,global_step,max_training_epochs/10,0.8,staircase=True)
