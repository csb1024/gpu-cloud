...
$PYTHON $TF $VAL_DIR/$DATA_FILE $VAL_DIR/$LABEL_FILE $VAL_DIR $ENSEMBLE_NUM_PARAM $layer_type $2 $LOG_DIR > $LOG_DIR/$LOG_FILE

else
$PYTHON $TF $VAL_DIR/$DATA_FILE $VAL_DIR/$LABEL_FILE $VAL_DIR $ENSEMBLE_NUM_PARAM $layer_type $2 $LOG_DIR
