...
"""
The input vector of Scenario 1 :
- input data size -> ?? no way 
- batch size 
- number of conv layers
- summation of outputs for conv layer
- minumum stride
- minumum kernel size
- number of IP layers
- summation of outputs for IP layer
- number  of pooling layers
- type of output function(maybe as enum?)
	-> may not be required
	-> lets skip for now(2017-3-12)


my thoughts ? 
we cannot know the size of input data
cannot(hard to ) catch the realtion between layers
"""
